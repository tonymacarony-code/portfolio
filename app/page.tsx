    ...
    <>
      ...
      <main >
        ...
        <section id='projects' className="px-6 md:px-10 pt-10 md:pt-104 grid grid-cols-1 gap-4">
          ...
          <div className="mt-8 lg:mt-16 grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-8 md:gap-y-20">
        ...
        <section id='services' className='px-6 md:px-10 pt-14 lg:pt-40'>
          <SectionTitle name='services' />
          <div className="mt-10 lg:mt-16 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
