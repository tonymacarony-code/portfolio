    ...
    return (
        <>
            ...
            >
                ...
                {/* 2 */}
                <SwiperSlide>
                    <div className='text-3xl font-bold tracking-tighter'>Why web development?</div>
                    <div className='mt-5 text-xl md:text-2xl'>Because it combines creativity and logic, letting me bring ideas to life and enhance the value of websites through better user interaction.</div>
                    <Image className='mt-4 gif' unoptimized src="/pc-guy.gif" width={300} height={100} alt="pc-guy" />
                </SwiperSlide>                {/* 3 */}
                <SwiperSlide>
                    <div className='text-3xl font-bold tracking-tighter'>Motivation</div>
                ...
                <SwiperSlide>
                    <div className='text-3xl font-bold tracking-tighter'>I shine when i...</div>
                    <div className='mt-5 text-xl md:text-2xl'>I shine when I collaborate with team. I believe that when everyone is aligned, great results are achieved. Working together and helping others brings out the best in me.</div>
                    <div className='mt-4 gif'>
                ...
                <SwiperSlide>
                    <div className='text-3xl font-bold tracking-tighter'>Hobby</div>
                    <div className='mt-5 text-xl md:text-2xl'>Since childhood, I’ve been passionate about heavy metal. I taught myself to play guitar using YouTube, and it’s been an inseparable part of my life ever since.</div>
                ...
                {/* 5 */}
                <SwiperSlide>
                    <div className='text-3xl font-bold tracking-tighter'>Music lover</div>
                ...
                {/* 5 */}
                <SwiperSlide>
                    <div className='text-3xl font-bold tracking-tighter'>Landscape hunter</div>
                    <div className='mt-5 text-xl md:text-2xl'>I love creating videos of the landscapes from the places I&apos;ve visited. Hiking combined with videography is a form of relaxation for me.</div>
                    <div className="mt-3">
